...
Norway Open Data SDK is currently version `0.1.0` and has not yet been published to npm. The public
surface is usable, tested and typed, but it should not be treated as a 1.0 stability promise.
